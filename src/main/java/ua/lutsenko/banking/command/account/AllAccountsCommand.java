...
public class AllAccountsCommand implements Command {
    ...
    public String execute(RequestWrapper wrapper) {
        ...
        wrapper.addNewAttribute("accountConditions", accountConditions);
        wrapper.addNewAttribute("listCreditConditions", listCreditConditions);
        wrapper.addNewAttribute("listDebitConditions", listDebitConditions);
